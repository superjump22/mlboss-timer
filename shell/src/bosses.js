...
// skill: { id, pid, label, labelEn, cd, warn, color, voice, voiceEn, nameable? }
// - nameable: PB 的 R/TL 位 (名字纯本地存储, 服务器不同步 — 见交接文档 3.3 实测结论)
// - label 即 nameable 格子的占位符 (无自定义名字时显示)
// 语音措辞: PB zombie / HT 全部待用户终审 (Phase 7 生成前过目)
    ...
    groups: [
      {
        ...
        labelEn: "Left Arm",
        skills: [
          { id: "laSed1", pid: "laSed1", label: "左手诱惑1", labelEn: "LA SED#1", cd: 180, warn: 5, color: "#ffb84d", voice: "左手诱惑1好了", voiceEn: "LA SED 1 ready" },
          { id: "laSed2", pid: "laSed2", label: "左手诱惑2", labelEn: "LA SED#2", cd: 180, warn: 5, color: "#ffb84d", voice: "左手诱惑2好了", voiceEn: "LA SED 2 ready" },
          { id: "laSed3", pid: "laSed3", label: "左手诱惑3", labelEn: "LA SED#3", cd: 180, warn: 5, color: "#ffb84d", voice: "左手诱惑3好了", voiceEn: "LA SED 3 ready" },
          { id: "laMass", pid: "laMass", label: "左手群体", labelEn: "LA MASS", cd: 60, warn: 5, color: "#6fdcff", voice: "左手群体好了", voiceEn: "LA MASS ready" },
          { id: "laDp1", pid: "laDp1", label: "左手DP1", labelEn: "LA DP#1", cd: 300, warn: 5, color: "#ff6b6b", voice: "左手DP1好了", voiceEn: "LA DP 1 ready" },
          { id: "laDp2", pid: "laDp2", label: "左手DP2", labelEn: "LA DP#2", cd: 180, warn: 5, color: "#ff6b6b", voice: "左手DP2好了", voiceEn: "LA DP 2 ready" },
        ],
      },
      {
        id: "ra",
        ...
        labelEn: "Right Arm",
        skills: [
          { id: "raSed1", pid: "raSed1", label: "右手诱惑1", labelEn: "RA SED#1", cd: 180, warn: 5, color: "#ff8f1f", voice: "右手诱惑1好了", voiceEn: "RA SED 1 ready" },
          { id: "raSed2", pid: "raSed2", label: "右手诱惑2", labelEn: "RA SED#2", cd: 180, warn: 5, color: "#ff8f1f", voice: "右手诱惑2好了", voiceEn: "RA SED 2 ready" },
          { id: "raSed3", pid: "raSed3", label: "右手诱惑3", labelEn: "RA SED#3", cd: 180, warn: 5, color: "#ff8f1f", voice: "右手诱惑3好了", voiceEn: "RA SED 3 ready" },
          { id: "raMass", pid: "raMass", label: "右手群体", labelEn: "RA MASS", cd: 60, warn: 5, color: "#2f9bff", voice: "右手群体好了", voiceEn: "RA MASS ready" },
        ],
      },
      {
        id: "mh",
