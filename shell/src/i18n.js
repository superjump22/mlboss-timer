...
const dict = {
  zh: {
    ...
    offsetSaved: "已保存 {n}s 偏移",
    offsetSynced: "已同步 {n}s 偏移",
  ...
  en: {
    ...
    scale: "UI scale",
    offsetLabel: "Offset",
    offsetTip: "Reduces every timer duration by this many seconds (min 5s), synced room-wide; outside a room it sets the default for next room",
    offsetApply: "Apply",
    offsetErr: "Enter an integer 0-30",
    offsetApplied: "Applied {n}s offset",
    offsetSaved: "Saved {n}s offset (default for next room)",
    offsetAuto: "Auto-applied last offset {n}s",
    offsetSynced: "Synced {n}s offset (from room)",
